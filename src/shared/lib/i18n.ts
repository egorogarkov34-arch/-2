...
const copy = {
  ru: {
    ...
    personalSpace: 'Личное пространство', personalPlan: 'Персональный план', perDay: 'в день', recommendation: 'Рекомендация',
  ...
  en: {
    ...
    personalSpace: 'Personal space', personalPlan: 'Personal plan', perDay: 'per day', recommendation: 'Recommendation',
