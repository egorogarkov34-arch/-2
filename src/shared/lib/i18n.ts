...
const copy = {
  ru: {
    ...
    noEntriesHint: 'Добавьте воду — первая запись появится здесь.', close: 'Закрыть',
    ...
    activity: 'Уровень активности', workout: 'Тренировка сегодня', workoutMinutes: 'Минут тренировки', low: 'Низкий', moderate: 'Средний', high: 'Высокий', settings: 'Настройки',
    reminders: 'Напоминания', notificationFrequency: 'Частота уведомлений', darkTheme: 'Тёмная тема', enabled: 'Включена',
  ...
  en: {
    ...
    noEntriesHint: 'Add water and your first entry will appear here.', close: 'Close',
    ...
    activity: 'Activity level', workout: 'Workout today', workoutMinutes: 'Workout minutes', low: 'Low', moderate: 'Moderate', high: 'High', settings: 'Settings',
    reminders: 'Reminders', notificationFrequency: 'Reminder frequency', darkTheme: 'Dark theme', enabled: 'On',
